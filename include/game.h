...
#define NEURAL_NETWORK_INIT_TOPOLOGY { 15, 10, 20, 20, 8, 2 }
#define NEURAL_NETWORK_RESET_MUTATION_RATE 0.1f
#define NEURAL_NETWORK_RESET_MUTATION_PROB 0.02f
#define NEURAL_NETWORK_CHILD_MUTATION_RATE 0.3f
#define NEURAL_NETWORK_CHILD_MUTATION_PROB 0.05f
#define NEURAL_NETWORK_TOPOLOGY_MUTATION_PROBABILITY 0.01f
